function Get-365InboundSpamDetections {
    <#
        .SYNOPSIS
            PowerShell script to pull all Inbound Spam Detections from Exchange Mailflow data
        .DESCRIPTION
            PowerShell script to pull all Inbound Spam Detections from Exchange Mailflow data with a certain date range.
