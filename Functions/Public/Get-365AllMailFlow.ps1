function Get-365AllMailFlow {
        <#
        .SYNOPSIS
            PowerShell script to pull all Exchange Mailflow data into excel
        .DESCRIPTION
            PowerShell script to pull all Exchange Mailflow data into excel with a certain date range.
